...
public class DefaultDataTestBase {
  ...
  public static final String DEFAULT_BROWSER="firefox";//iexplorer, firefox, chrome
  public static final String DEFAULT_SERVER="ubuntu"; //win, ubuntu
  ...
  public static final  String DEFAULT_SQLUSER = "select type,username,password,email from user order by id asc";
