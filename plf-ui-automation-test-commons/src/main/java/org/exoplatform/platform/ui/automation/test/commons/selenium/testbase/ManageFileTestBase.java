...
public class ManageFileTestBase {
  ...
  public void attachFile(String pathFile, String fileName, final int timeout, WebDriver driver) {
    ...
    WebElement
            element =
            testBase.waitForAndGetElement(LocatorTestBase.ELEMENT_UPLOAD_POPUP_ATTACHMENT_FILE_INPUT,
                                          timeout,
                                          1,
                                          2);
  ...
  public void downloadFileUsingAutoIt(String file) {
    ...
    try {
      Process
              proc =
              Runtime.getRuntime().exec(pathDownload + " " + getAbsoluteFilePath("TestData" + fs + "TestOutput" + fs + file));
  ...
  private void initFilesPath(){
    ...
    if (portalDefaultFilePath==null) portalDefaultFilePath = DefaultDataTestBase.DEFAULT_PORTAL_DEFAULT_GATEIN_URL;
    ...
    //Social
    if (spaceUIFilePath==null) spaceUIFilePath = DefaultDataTestBase.DEFAULT_SPACE_UI_URL;
    ...
    if (spaceNavigationDefaultNodesFilePath == null) spaceNavigationDefaultNodesFilePath = DefaultDataTestBase.DEFAULT_SPACE_NAVIGATION_DEFAULT_NODES_URL + DefaultDataTestBase.DEFAULT_SPACE_NAVIGATION_DEFAULT_NODES_URL;
